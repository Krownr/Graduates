                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="{{url('theses')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-lg" id="topicInput" placeholder="thesis topic" name="topic">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-lg" id="topicInput" placeholder="thesis mark" name="mark">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-lg" id="dateInput" name="date">
                            </div>
